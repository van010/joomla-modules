...
//
// Changes made by Joomla for RTL for 3.0
//

//
// Changes made by JoomlArt for fixing get dimension of hidden element in Joomla 2.5 setting form
//
(function() {
  var SelectParser;
...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      jQuery(this.form_field_jq).show();
      this.f_width = this.form_field_jq.actual('outerWidth') + 20;//adding 20px to fix bug text is cut off
      container_div = $("<div />", {
      ...
      if (this.is_multiple) {
        // Changed left:-9000 to display:none for rtl
    ...
    Chosen.prototype.search_field_scale = function() {
      ...
      if (this.is_multiple) {
        ...
        $('body').append(div);
        w = div.actual('width') + 20 + 25;//adding 20px to fix bug text is cut off
        div.remove();
  ...
  get_side_border_padding = function(elmt) {
    ...
    return side_border_padding = elmt.actual('outerWidth') - elmt.actual('width');
  };
