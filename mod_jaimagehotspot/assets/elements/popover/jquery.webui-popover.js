    ...
    (function(factory) {
        ...
        WebuiPopover.prototype = {
            ...
            */
            ...
            show: function() {
                // console.log('popup prevent tap '+pinchDuration);
                if (pinchDuration)
                    return;
                if (this._opened) {
                    return;
            ...
            displayContent: function() {
                ...
                if (this.options.style) {
                    this.$target.addClass(this.options.style);
                }
            ...
            setContentASync: function(content) {
                ...
                this.xhr = $.ajax({
                    ...
                    dataType: this.options.async.dataType,
                    cache: this.getCache(),
            ...
            */
            ...
            getElementPosition: function() {
                ...
                if (container.is(document.body) || cssPos === 'static') {
                    ...
                    return {
                        top: elRect.top - containerRect.top + jQuery(window).scrollTop(),
                        left: elRect.left - containerRect.left + jQuery(window).scrollLeft(),
                        width: elRect.width,
            ...
            getTargetPositin: function(elementPos, placement, targetWidth, targetHeight) {
                var pos = elementPos,
                    ...
                    scrollTop = document.documentElement.scrollTop + jQuery(window).scrollTop(),
                    scrollLeft = document.documentElement.scrollLeft + jQuery(window).scrollLeft(),
                    position = {},
                    arrowOffset = null,
