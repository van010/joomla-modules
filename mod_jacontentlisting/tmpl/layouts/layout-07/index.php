...
?>
<div class="jacl-layout layout-7 <?php echo "mod".$modid;?> <?php echo $helper->get('class_sfx') ?>">
	...
	<div class="jacl-layout__body">
		...
		<div class="jacl-row <?php echo $item_content_gutters; ?>">
			<div class="jacl-col-12 jacl-col-md-3 col-child">
				...
				<?php if (!empty($items[3])) $helper->renderItem($items[3]); ?>
			</div>
			...
			<div class="jacl-col-12 jacl-col-md-3 col-child">
				...
				<?php if (!empty($items[4])) $helper->renderItem($items[4]); ?>
			</div>
		</div>

		<div class="jacl-row other-items <?php echo $item_content_gutters; ?>">
		<?php for ($i=5; $i<count($items); $i++) : ?>
			<div class="jacl-col-12 jacl-col-md-3 jacl-col-lg-<?php echo $item_per_row_w; ?>">
