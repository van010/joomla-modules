...
$item_image = !empty($item->images) ? json_decode($item->images)  : '{}';
...
if (!empty($item_image->image_intro)) $class .= ' has-media';

?>

<div class="jacl-item eitem-style-2 <?php echo trim($class); ?> <?php echo $options->get('item_media_style'); ?>">
