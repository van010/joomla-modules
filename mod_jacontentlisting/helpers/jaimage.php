...
if (!class_exists('JAImage')) {
    ...
    class JAImage
    {
        ...
        function __construct()
        {
            ...
            $this->__cacheURL = Uri::root(true).'/images/resized/';
        }
        ...
        function resize($image, $width, $height, $crop = true, $aspect = true)
        {
            ...
            if (!file_exists($this->__cachePath) && !Folder::create($this->__cachePath)) {
                return '';
            }
         ...
         * save new risized images to source
         *
        ...
        function isLinkedImage($imageURL)
        {
            ...
            return strpos(Uri::base(), $parser['host']) ? false : $parser;
        }
         ...
         * @return boolean,
         */
        function sourceExisted($imageSource)
        {

            if ($imageSource == '' || $imageSource == '..' || $imageSource == '.') {
                return false;
            }
            $imageSource = str_replace(Uri::base(), '', $imageSource);
