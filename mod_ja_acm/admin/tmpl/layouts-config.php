...
<div class="ja-acm-admin joomla<?php echo substr(JVERSION, 0, 1) ?>">
	...
	<div class="control-group jatools-header ">
		...
		<div class="control-label">
			<label id="jatools-type-lbl" for="jatools-type" class="hasTip" title="<?php echo Text::_('MOD_JA_ACM_TYPE_DESC') ?>"><?php echo Text::_('MOD_JA_ACM_TYPE_LABEL') ?></label>
		</div>

		<div class="controls">
			<select id="jatools-type" name="jatools-type" class="required">
				<option value="" selected="selected"><?php echo Text::_('MOD_JA_ACM_LAYOUT_DEFAULT') ?></option>
...
<div id="acm-advanced-form" class="hide" title="<?php echo Text::_('MOD_JA_ACM_ADVANCED_FORM_TITLE') ?>">
	<textarea id="acm-advanced-input"></textarea>
</div>

<div id="acm-dialog-confirm" class="hide" title="<?php echo Text::_('MOD_JA_ACM_CONFIRM_DELETE_TITLE') ?>">
	<?php echo Text::_('MOD_JA_ACM_CONFIRM_DELETE_MSG') ?>
</div>
